...
const main = async () => {
  ...
  let CSVFILE = "gtgs_wallets_100_xdai_and_tokens.csv"

  let contents = fs.readFileSync(CSVFILE)
  ...
  for(let l in lines){
    console.log("line",l,lines[l].split(","))
  }
...
/*
  ...
  for(let c=0;c<count;c++){
    ...
    const fullLink = domain+randomPk
    //console.log(fullLink)
    links.push(fullLink)
    CSVFILE+= ""+c+","+randomWallet.address+","+randomPk+","+fullLink+"\n"
  }


  fs.writeFileSync("gtgs_wallets_"+Date.now()+".csv",CSVFILE)
