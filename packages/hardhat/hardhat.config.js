...
module.exports = {
  ...
  networks: {
    ...
    rinkeby: {
      url: "https://rinkeby.infura.io/v3/f0c9f4449331457db6be5fcef7db0208", // <---- YOUR INFURA ID! (or it won't work)
    ...
    mainnet: {
      url: "https://mainnet.infura.io/v3/f0c9f4449331457db6be5fcef7db0208", // <---- YOUR INFURA ID! (or it won't work)
