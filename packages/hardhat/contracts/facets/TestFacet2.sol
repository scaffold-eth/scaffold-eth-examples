...
abstract contract DydxInterface {
    ...
    function operate(Info[] memory accounts, ActionArgs[] memory actions) public virtual;
...
contract Helper {
    ...
    function getDAIDyDx() public pure returns (address dai) {
        dai = 0x4F96Fe3b7A6Cf9725f59d353F723c1bDb64CA6Aa;
    }
}


contract TestFacet2 is Helper, DydxInterface{
    ...
    function borrow(Info[] memory accounts, ActionArgs[] memory actions, uint maxAmt) public {
        ...
        IERC20(getDAIDyDx()).approve(getOperation(), maxAmt);
        operate(accounts, actions);
   }
   
    function operate(Info[] memory accounts, ActionArgs[] memory actions) public override {
