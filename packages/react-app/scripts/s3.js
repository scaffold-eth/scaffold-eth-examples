...
const BUCKETNAME = "gtc.wtf"; // <<---- SET YOUR BUCKET NAME AND CREATE aws.json ** see below vvvvvvvvvv

const invalidation = {
   awsDistributionId: "E2G5EC8A16Z0FT",
   awsInvalidationPath: "/*"
}
  ...
  if (err) {
    ...
    s3.putBucketWebsite(staticHostParams, function(err, data) {
      if (err) {
        ...
        console.log("\n Uploaded to: http://"+BUCKETNAME+".s3-website-us-east-1.amazonaws.com/")
      }
    });
  }
});
