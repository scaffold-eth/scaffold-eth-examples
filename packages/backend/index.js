...
let currentMessageForUseToSign = "I am **ADDRESS** and I would like to view a video of @AustinGriffith chugging a beer!"
      ...
      if(recovered==userAddress){
        ...
        */
        ...
        if(userHasETH){
          ...
          response.send(" 😅 successfully signed in as ["+userAddress+"](https://etherscan.io/address/"+userAddress+") but you don't have any eth!");
        }
